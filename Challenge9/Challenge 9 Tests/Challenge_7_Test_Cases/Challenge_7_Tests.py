...
def test_send_Message_to_friends_mailbox():
    set_keyboard_input(["1", "I like pie", "3", "14"])
    Challenge_9.userName = "bradfordd"
    Challenge_9.subscription = "S"
    Challenge_9.sendMessage()
...
def test_view_and_delete_message():
    set_keyboard_input(["1", "2", "3", "14"])
    Challenge_9.userName = "bradforda"
    Challenge_9.subscription = "S"
    Challenge_9.viewMessages();
    output = get_display_output()
    assert output == [
                        '\n'
...
def test_create_an_account_with_premium_account():
    set_keyboard_input(["2", "Not", "AName", "allenda", "dsdas123A-", "P", "14"])
    Challenge_9.menu()
    output = get_display_output()
...
def test_send_messages_to_all_with_premium_account():
    set_keyboard_input(["1", "I like pie", "3", "14"])
    Challenge_9.userName = "plusmember"
    Challenge_9.subscription = "P"
    output = get_display_output()
    Challenge_9.sendMessage()
    output = get_display_output()
    assert output == [ 'P',
...
def test_view_and_delete_message_from_premium_account():
    set_keyboard_input(["1", "3", "Stop talking to me, you aren't my friend!", "3", "14"])
    Challenge_9.userName = "bradfordd"
    Challenge_9.subscription = "S"
    Challenge_9.viewMessages();
    output = get_display_output()
