...
def test_create_ten_accounts_5():
    set_keyboard_input(["Allen", "Cheng", "Allenc", "Cheng123-", "S", "2",
                        ...
                        "Dylan", "Bradford", "DylanB", "Cheng123-", "S", "14"])
    Challenge_9.create(Challenge_9.accountCount())


#Login to attempt test cases
def test_login1():
    set_keyboard_input(["Allenc", "Cheng123-", "14"])
    Challenge_9.login()
...
def test_login2():
    set_keyboard_input(["Raym", "Cheng123-", "14"])
    Challenge_9.login()


def test_apply_for_job():
    set_keyboard_input(["2", "1", "1", "May 2022", "May 2022", "I am good", "14"])
    Challenge_9.searchJob()
    output = get_display_output()
    assert output == ["\nSearch for a Job",
