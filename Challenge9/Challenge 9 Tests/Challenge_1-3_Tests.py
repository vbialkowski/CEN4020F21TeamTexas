...
def test_create_good_unique_non_log_in():
    set_keyboard_input(["John", "Smith", "allenda", "dsdas123A-", "S", "14"])
...
def test_create_good_non_unique_non_log_in():
    set_keyboard_input(["John", "Smith", "allenda", "dsdas123A-", "S", "John", "Smith", "dasbnnud", "dasdA123-=", "S", "14"])
    Challenge_9.create(Challenge_9.accountCount())
    output = get_display_output()
    assert output == ["\nCreate A Account",
                      "First Name: ",
...
def test_create_bad_unique_non_log_in():
    set_keyboard_input(["John", "Smith", "allenda", "dsdas123A", "dasbnnud1", "dasdA123-=","S", "14"])
    Challenge_9.create(Challenge_9.accountCount())
    output = get_display_output()
    assert output == ["\nCreate A Account",
                      "First Name: ",
...
def test_login_good():
    set_keyboard_input(["allenda", "dsdas123A-", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
...
def test_login_bad():
    set_keyboard_input(["allenda", "dsdas123-", "allenda", "dsdas123A-", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
                      "Please Enter Your UserName: ",
...
def test_create_good_unique_log_in():
    set_keyboard_input(["John", "Smith", "allenda2", "dsdas123A-", "S", "14"])
    Challenge_9.create(Challenge_9.accountCount())
    output = get_display_output()
    assert output == ["\nCreate A Account",
                      "First Name: ",
...
def test_pass_non_alpha():
    assert Challenge_9.passCheck("dsadAda123") == False


def test_pass_8_char():
    assert Challenge_9.passCheck("dsad2-A") == False


def test_pass_12_char():
    assert Challenge_9.passCheck("dasbdui123abduas-Abdia") == False


def test_pass_upper():
    assert Challenge_9.passCheck("dsa12331-") == False


def test_pass_digit1():
    assert Challenge_9.passCheck("saas=A=+a=-") == False


def test_learn_skill_beta():
    set_keyboard_input(["1"])
    Challenge_9.learnSkill()
    output = get_display_output()
    assert output == ["\nLearn a New Skill",
                      "[1] Learn ...",
                      "[2] Learn ...",
...
def test_posting_a_job_logged_in():
    set_keyboard_input(["1", "Software Engineer", "You have to develop software", "Google",
                        "California", "$80000", "5", "14"])
    Challenge_9.searchJob()
    output = get_display_output()
    assert output == ["\nSearch for a Job",
...
def test_posting_a_job_not_logged_in():
    set_keyboard_input(["1", "14"])
    Challenge_9.signedIn = False
    Challenge_9.searchJob()
    output = get_display_output()
    assert output == ["\nSearch for a Job",
                      "[1] Return to Options",
...
def test_search_for_user_successful():
    set_keyboard_input(["John", "Smith", "3", "14"])
    Challenge_9.findSomeone()
    output = get_display_output()
...
def test_search_for_user_failed():
    set_keyboard_input(["John", "Smithhh", "14"])
    Challenge_9.findSomeone()
    output = get_display_output()
    assert output == ["\nFind Someone You Know",
                      "Enter Their First Name: ",
...
def test_copyright_notice():  # SPRINT3
    set_keyboard_input(["1", "10", "14"])
    Challenge_9.ImportantLinks()
    output = get_display_output()
    assert output == ["\nImportant Links",
                      "[1] Copyright Notice",
                      "[2] About",
...
def test_privacypolicy_signedin_notice():  # SPRINT3
    set_keyboard_input(["allenda", "dsdas123A-", "8", "5", "4", "10", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
                      "Please Enter Your UserName: ",
