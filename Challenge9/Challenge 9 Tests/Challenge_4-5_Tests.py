...
def test_create_ten_accounts_5():
    set_keyboard_input(["James", "Johnson", "James11!", "Johnson11!", "S", "2",
                        ...
                        "John", "Smith", "JohnS11!", "Spider11!", "S", "14"])
    Challenge_9.create(Challenge_9.accountCount())
    assert Challenge_9.accountCount() == 10


# Challenge 5
# Test to make sure up to 10 accounts can be created
def test_maximum_accounts_number_5():
    set_keyboard_input(["14"])
    Challenge_9.create(Challenge_9.accountCount())
...
def test_experience_profile():
    set_keyboard_input(["1", "5", "1", "Code Developer", "Disney", "11/16/19",
                        ...
                        "7", "3", "14"])
    Challenge_9.signedIn = True
    Challenge_9.current_Name = "John Smith"
    Challenge_9.firstName = "John"
    Challenge_9.lastName = "Smith"
    Challenge_9.userName = "JohnS11!"
    Challenge_9.password = "Spider11!"
    Challenge_9.emailOpt = "On"
    Challenge_9.smsOpt = "On"
    Challenge_9.advOpt = "On"
    Challenge_9.languageOpt = "English"
    Challenge_9.titleOpt = "None"
    Challenge_9.majorOpt = "None"
    Challenge_9.UniOpt = "None"
    Challenge_9.aboutOpt = "None"
    Challenge_9.expOpt1Title = "Title: None"
    Challenge_9.expOpt1Emp = "Employer: None"
    Challenge_9.expOpt1Start = "Start Date: None"
    Challenge_9.expOpt1End = "End Date: None"
    Challenge_9.expOpt1Loc = "Job Location: None"
    Challenge_9.expOpt1Des = "Description: None"
    Challenge_9.expOpt2Title = "Title: None"
    Challenge_9.expOpt2Emp = "Employer: None"
    Challenge_9.expOpt2Start = "Start Date: None"
    Challenge_9.expOpt2End = "End Date: None"
    Challenge_9.expOpt2Loc = "Job Location: None"
    Challenge_9.expOpt2Des = "Description: None"
    Challenge_9.expOpt3Title = "Title: None"
    Challenge_9.expOpt3Emp = "Employer: None"
    Challenge_9.expOpt3Start = "Start Date: None"
    Challenge_9.expOpt3End = "End Date: None"
    Challenge_9.expOpt3Des = "Description: None"
    Challenge_9.expOpt3Loc = "Job Location: None"
    Challenge_9.eduOptSchool = "School: None"
    Challenge_9.eduOptDegree = "Degree: None"
    Challenge_9.eduOptYears = "Years: None"
    Challenge_9.variable = 0

    Challenge_9.personalProfile()
...
def test_major_profile():
    set_keyboard_input(["1", "2", "computer science", "7", "3", "14"])
    Challenge_9.signedIn = True
    Challenge_9.current_Name = "John Smith"
    Challenge_9.firstName = "John"
    Challenge_9.lastName = "Smith"
...
def test_about_profile():
    set_keyboard_input(["1", "4", "I am currently a student at the University of South Florida. "
                             ...
                             "worked as a programmer to write functioning software.", "7", "3", "14"])
...
def test_title_profile():
    set_keyboard_input(["1", "1", "3rd Year Computer Science Student", "7", "3", "14"])
    Challenge_9.signedIn = True
    Challenge_9.current_Name = "John Smith"
    Challenge_9.firstName = "John"
    Challenge_9.lastName = "Smith"
...
def test_login_and_accept_request():
    set_keyboard_input(["Harry11!", "Lewis11!", "11", "1", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
...
def test_login_and_reject_friends():
    set_keyboard_input(["JohnS11!", "Spider11!", "11", "2", "2", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
                      "Please Enter Your UserName: ",
...
def test_view_friend_list():
    set_keyboard_input(["Daniel11!", "Jones11!", "10", "4", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
                      "Please Enter Your UserName: ",
...
def test_view_friend_profile():
    set_keyboard_input(["Daniel11!", "Jones11!", "10", "3", "JohnS11!", "4", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
                      "Please Enter Your UserName: ",
...
def test_view_friend_with_no_profile():
    set_keyboard_input(["Harry11!", "Lewis11!", "10", "3", "Daniel11!", "4", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
                      "Please Enter Your UserName: ",
...
def test_view_profile_of_not_friend():
    set_keyboard_input(["Matt11!", "Harris11!", "10", "3", "Eddie11!", "4", "14"])
    Challenge_9.login()
    output = get_display_output()
    assert output == ["\nLog In",
                      "Please Enter Your UserName: ",
